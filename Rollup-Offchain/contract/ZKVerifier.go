...
func (_ZKVerifier *ZKVerifierCaller) VerifyProof(opts *bind.CallOpts, a [2]*big.Int, b [2][2]*big.Int, c [2]*big.Int, input [4]*big.Int) (bool, error) {
	var out []interface{}
	err := _ZKVerifier.contract.Call(opts, &out, "verifyProof", a, b, c, input)
...
//
// Solidity: function verifyProof(uint256[2] a, uint256[2][2] b, uint256[2] c, uint256[4] input) view returns(bool r)
func (_ZKVerifier *ZKVerifierSession) VerifyProof(a [2]*big.Int, b [2][2]*big.Int, c [2]*big.Int, input [4]*big.Int) (bool, error) {
	return _ZKVerifier.Contract.VerifyProof(&_ZKVerifier.CallOpts, a, b, c, input)
}

// VerifyProof is a free data retrieval call binding the contract method 0x6668a9fa.
//
// Solidity: function verifyProof(uint256[2] a, uint256[2][2] b, uint256[2] c, uint256[4] input) view returns(bool r)
func (_ZKVerifier *ZKVerifierCallerSession) VerifyProof(a [2]*big.Int, b [2][2]*big.Int, c [2]*big.Int, input [4]*big.Int) (bool, error) {
	return _ZKVerifier.Contract.VerifyProof(&_ZKVerifier.CallOpts, a, b, c, input)
}
