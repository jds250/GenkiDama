...
func QuestionerRouting(eventDetail *contract.BCPManagerChallengeStateNotify, client *ethclient.Client, auth *bind.TransactOpts, caller *bind.CallOpts, ctx context.Context) {
